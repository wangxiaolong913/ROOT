...
<table border="0" cellpadding="0" cellspacing="0" class="tm_message">
	...
	<tbody>
		<tr>
			...
			<td>
				<div class="tm_message_msg"><tomtag:Message key="message.other.status_expired" /></div>
				<div class="tm_message_btns">
					<a href="login.thtml" target="_parent" class='tm_btn tm_btn_primary'><tomtag:Message key="message.other.relogin" /></a>
				</div>
			</td>
		</tr>
	</tbody>
