...
<head>
	...
	<script type="text/javascript">
		...
		function submitCourse(){
			var formcheck = $("#form_course_add").validationEngine('validate');
			if(formcheck){
				//formatFilePath();
				$("#form_course_add").attr("action","${tm_base}system/course/save.do");
				$("#form_course_add").submit();
			}else{
				return false;
			}
		}
...
<body>
	...
	<div class="tm_main">
        ...
        <br/>
        <div class="tm_container">
			<form action="" method="post" id="form_course_add">
