...
//			String new_pass = md.convertMD5(md.convertMD5(new String(userpass)));
			String new_pass = md.string2MD5(new String(userpass));
	...
	public int updateAdminProfile(Map<String, Object> admin) {
		...
		try {
			...
			if (BaseUtil.isNotEmpty(a_userpass)) {
				...
				Md5Util md = new Md5Util();
				String password = md.string2MD5(a_userpass);
