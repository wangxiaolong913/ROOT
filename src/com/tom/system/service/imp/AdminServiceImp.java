  ...
  implements IAdminService
{
  ...
  public int addAdmin(Map<String, Object> admin)
  {
    try
    {
      ...
      {
        String password = ((Md5Util)WebApplication.getInstance().getSingletonObject(Md5Util.class)).getMD5ofStr(Constants.SYS_IDENTIFICATION_CODE + userpass + salt);
  ...
  public int doLogin(String username, String userpass)
  {
    try
    {
      ...
      String userpass_xn = ((Md5Util)WebApplication.getInstance().getSingletonObject(Md5Util.class)).getMD5ofStr(Constants.SYS_IDENTIFICATION_CODE + userpass + salt);
