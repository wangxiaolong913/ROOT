  ...
  extends BaseController
{
  ...
  public ModelAndView save(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    int i = this.user_service.addUser(getRequestData(request));
    if (i == 2) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.user.add", "message.sys.success" }));
    } else if (i == 3) {
      ...
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.user.add", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.add"), "system/user/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.list"), "system/user/list.thtml"));
    modelMap.put("message", message);
  ...
  public ModelAndView batchImport(HttpServletRequest request, @RequestParam(value="u_file", required=false) MultipartFile file, ModelMap modelMap)
  {
    ...
    {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.user.import", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.add"), "system/user/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.list"), "system/user/list.thtml"));
    modelMap.put("message", message);
  ...
  public ModelAndView delete(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    BaseMessage message = null;
    if (i == 1) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.user.delete", "message.sys.success" }));
    } else {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.user.delete", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.add"), "system/user/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.user.list"), "system/user/list.thtml"));
    modelMap.put("message", message);
  ...
  public ModelAndView batchOperation(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    if ("batch_delete".equals(op))
    {
      ...
      {
        message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.user.batch.delete", "message.sys.failed" }));
      }
    }
    else if ("batch_status".equals(op))
    {
      ...
      {
        message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.user.batch.update", "message.sys.failed" }));
      }
    }
