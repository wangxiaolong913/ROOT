  ...
  extends BaseController
{
  ...
  public ModelAndView save(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    if (i == 1) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.add", "message.sys.success" }));
    } else {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.add", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.add"), "system/paper/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.list"), "system/paper/list.thtml"));
    modelMap.put("message", message);
  ...
  public ModelAndView fastsave(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    if (i == 1) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.fastadd", "message.sys.success" }));
    } else {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.fastadd", "message.sys.failed" }));
    }
  ...
  public ModelAndView delete(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    BaseMessage message = null;
    if (i == 1) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.delete", "message.sys.success" }));
    } else if (i == 2) {
      message = new BaseMessage(false, MessageHelper.getMessage("message.sys.paper.hasUsers"));
    } else {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.delete", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.add"), "system/paper/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.list"), "system/paper/list.thtml"));
    modelMap.put("message", message);
  ...
  public ModelAndView update(HttpServletRequest request, ModelMap modelMap)
  {
    ...
    if (i == 1) {
      message = new BaseMessage(true, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.update", "message.sys.success" }));
    } else {
      message = new BaseMessage(false, MessageHelper.getMessages(" ", new String[] { "message.sys.paper.update", "message.sys.failed" }));
    }
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.add"), "system/paper/add.thtml"));
    message.addUrl(new BaseUrl(MessageHelper.getMessage("txt.sys.paper.list"), "system/paper/list.thtml"));
    modelMap.put("message", message);
